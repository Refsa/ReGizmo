...
namespace ReGizmo.Utils
{
    internal static class ReGizmoPrimitives
    {
        ...
        public static Mesh Quad(Vector2 size)
        {
            ...
            return CreateMesh(vertices, indices, normals, uvs, "quad");
        }
        ...
        static readonly int[] cubeIndices = new[]
        {
            0, 2, 3, 0, 3, 1, 8, 4, 5, 8, 5, 9, 10, 6, 7, 10, 7, 11, 12, 13, 14, 12, 14, 15, 16, 17, 18, 16, 18, 19,
            20, 21, 22, 20, 22, 23
        };

        static readonly Vector3[] cubeNormals = new Vector3[]
        {
        ...
        public static Mesh Cube(Vector3 size)
        {
            ...
            return CreateMesh(cubeVertices, cubeIndices, cubeNormals, "cube");
        }
        ...
        public static Mesh Pyramid(Vector2 size, float height)
        {
            ...
            return CreateMesh(vertices, indices, "pyramid");
        }
        ...
        public static Mesh Octahedron(float radius = 1f)
        {
            ...
            return CreateMesh(vertices, indices, "octahedron");
        }

        static readonly Vector3[] capsuleVertices = new[]
        {
        ...
        static readonly int[] capsuleIndices = new[]
        {
        ...
        static readonly Vector3[] capsuleNormals = new[]
        {
        ...
        {
            return CreateMesh(capsuleVertices, capsuleIndices, capsuleNormals, "capsule");
        }

        static readonly Vector3[] cylinderVertices = new[]
        {
        ...
        static readonly int[] indices = new[]
        {
        ...
        static readonly Vector3[] cylinderNormals = new[]
        {
        ...
        public static Mesh Cylinder(float radius = 1f, float height = 1f, int resolution = 10)
        {
            ...
            return CreateMesh(cylinderVertices, indices, cylinderNormals, "cylinder");
        }
        ...
        public static Mesh Cone(float radius = 1f, float height = 1f, int resolution = 10)
        {
            ...
            return CreateMesh(vertices, indices, "cone");
        }
        ...
        public static Mesh Sphere(float radius = 1f, int resolution = 10)
        {
            ...
            return CreateMesh(vertices, indices, "sphere");
        }
        ...
        static Mesh CreateMesh(Vector3[] vertices, int[] indices, string name)
        {
            var mesh = new Mesh();
            mesh.name = name;
        ...
        static Mesh CreateMesh(Vector3[] vertices, int[] indices, Vector3[] normals, Vector2[] uvs, string name)
        {
            var mesh = new Mesh();
            mesh.name = name;
        ...
        static Mesh CreateMesh(Vector3[] vertices, int[] indices, Vector3[] normals, string name)
        {
            var mesh = new Mesh();
            mesh.name = name;
        ...
        static Mesh CreateMesh(List<Vector3> vertices, List<int> indices, string name)
        {
            var mesh = new Mesh();
            mesh.name = name;
