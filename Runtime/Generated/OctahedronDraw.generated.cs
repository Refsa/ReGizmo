...
namespace ReGizmo.Drawing
{
    public partial class ReDraw
    {
        ...
        public static void Octahedron(UnityEngine.Quaternion rotation, UnityEngine.Vector3 scale, UnityEngine.Color color)
        {
            if (ReGizmoResolver<ReGizmoOctahedronDrawer>.TryGet(out var drawer))
            {
                ref var shaderData = ref drawer.GetShaderData();
        ...
        public static void Octahedron(UnityEngine.Quaternion rotation, UnityEngine.Vector3 scale)
        {
            if (ReGizmoResolver<ReGizmoOctahedronDrawer>.TryGet(out var drawer))
            {
                ref var shaderData = ref drawer.GetShaderData();
