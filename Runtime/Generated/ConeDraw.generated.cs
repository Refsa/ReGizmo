...
namespace ReGizmo.Drawing
{
    public partial class ReDraw
    {
        ...
        public static void Cone(UnityEngine.Quaternion rotation, UnityEngine.Vector3 scale, UnityEngine.Color color)
        {
            if (ReGizmoResolver<ReGizmoConeDrawer>.TryGet(out var drawer))
            {
                ref var shaderData = ref drawer.GetShaderData();
        ...
        public static void Cone(UnityEngine.Quaternion rotation, UnityEngine.Vector3 scale)
        {
            if (ReGizmoResolver<ReGizmoConeDrawer>.TryGet(out var drawer))
            {
                ref var shaderData = ref drawer.GetShaderData();
