...
namespace ReGizmo.Drawing
{
    public partial class ReDraw
    {
        ...
        public static void Sphere(UnityEngine.Quaternion rotation, UnityEngine.Vector3 scale, UnityEngine.Color color)
        {
            if (ReGizmoResolver<ReGizmoSphereDrawer>.TryGet(out var drawer))
            {
                ref var shaderData = ref drawer.GetShaderData();
        ...
        public static void Sphere(UnityEngine.Quaternion rotation, UnityEngine.Vector3 scale)
        {
            if (ReGizmoResolver<ReGizmoSphereDrawer>.TryGet(out var drawer))
            {
                ref var shaderData = ref drawer.GetShaderData();
