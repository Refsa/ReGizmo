...
namespace ReGizmo.Drawing
{
    public partial class ReDraw
    {
        ...
        {
            if (ReGizmoResolver<ReGizmoPyramidDrawer>.TryGet(out var drawer))
            {
        ...
        public static void Pyramid(UnityEngine.Quaternion rotation, UnityEngine.Vector3 scale, UnityEngine.Color color)
        {
            if (ReGizmoResolver<ReGizmoPyramidDrawer>.TryGet(out var drawer))
            {
                ref var shaderData = ref drawer.GetShaderData();
        ...
        public static void Pyramid(UnityEngine.Quaternion rotation, UnityEngine.Vector3 scale)
        {
            if (ReGizmoResolver<ReGizmoPyramidDrawer>.TryGet(out var drawer))
            {
                ref var shaderData = ref drawer.GetShaderData();
