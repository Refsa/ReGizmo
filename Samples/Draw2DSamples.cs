...
public class Draw2DSamples : MonoBehaviour
{
    ...
    void OnDrawGizmos()
    {
        ...
        // Screen-Space
        {
            ReDraw.Circle(Vector3.zero, Vector3.zero, circleOuterRadus * 40f, circleInnerRadius, Color.red);
            
            ReDraw.Triangle(Vector3.right * 12f, Vector3.zero, circleOuterRadus * 40f, circleInnerRadius * 40f, Color.green);
        }

        // World-Space
        {
            ReDraw.Circle(Vector3.zero, Vector3.up * 2, circleOuterRadus, circleInnerRadius, Color.green);
            ReDraw.Circle(Vector3.zero, Vector3.right * 2, circleOuterRadus, circleInnerRadius, Color.green);
            ReDraw.Circle(Vector3.zero, Vector3.forward * 2, circleOuterRadus, circleInnerRadius, Color.green);
            ...
            ReDraw.Circle(Vector3.back * 15f, (Quaternion.Euler(rotationX, 0f, rotationZ) * Vector3.up) * 2, circleOuterRadus, circleInnerRadius, Color.green);
            ReDraw.Circle(Vector3.back * 15f, (Quaternion.Euler(rotationX, 0f, rotationZ) * Vector3.right) * 2, circleOuterRadus, circleInnerRadius, Color.red);
            ReDraw.Circle(Vector3.back * 15f, (Quaternion.Euler(rotationX, 0f, rotationZ) * Vector3.forward) * 2, circleOuterRadus, circleInnerRadius, Color.blue);
            ...
            ReDraw.Triangle(Vector3.right * 12f, Vector3.up * 2, circleOuterRadus, circleInnerRadius, Color.red);
        }
        ...
        for (int i = 0; i < 64; i++)
        {
            ...
            ReDraw.Triangle(center + arrowDir * 3f, arrowDir, 0.12f, 0f, Color.red);
        }
