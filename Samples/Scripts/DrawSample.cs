...
namespace ReGizmo.Samples
{
    ...
    void Update()
    {
        ...
        void Draw()
        {
            ...
            // Ray
            {
                ReDraw.Ray(Vector3.left * 12f + Vector3.up, Vector3.up, Color.green);
                ReDraw.Ray(Vector3.left * 12f + Vector3.up, Vector3.right, Color.red);
                ReDraw.Ray(Vector3.left * 12f + Vector3.up, Vector3.forward, Color.blue);
                ReDraw.Ray(Vector3.left * 12f + Vector3.up, (Vector3.up + Vector3.right + Vector3.forward).normalized, Color.yellow);
            }
            ...
            // Custom Icons
            {
                ...
                {
                    ReDraw.Icon(customIcons[i], Vector3.left * 5 + Vector3.up * 2 * i, Color.white, Size.Pixels(32f));
                }
            }
